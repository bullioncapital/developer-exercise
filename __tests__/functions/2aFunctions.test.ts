...
} from "../../src/functions/2aFunctions";
...
const data3: ICsvDataRange = {
  dataToBeObserved: [
    { date: 1960, value: 50.776 },
    { date: 1961, value: 50.0 },
    { date: 1962, value: 50.362 },
    { date: 1963, value: 50.73 },
    { date: 1964, value: 50.715 },
    { date: 1965, value: 50.7 },
...
describe("Testing 2aFunctions", () => {
  test("getDataBetweenDates - test 1", () => {
    expect(getDataBetweenDates(1980, 1990, [data])).toEqual([
      {
        countryName: "Aruba",
        countryCode: "ABW",
        indicatorName: "Urban population (% of total)",
  ...
  test("getDataBetweenDates - test 2", () => {
    expect(getDataBetweenDates(2001, 2005, [data])).toEqual([
      {
        countryName: "Aruba",
        countryCode: "ABW",
        indicatorName: "Urban population (% of total)",
  ...
  test("getDataBetweenDates - test 3", () => {
    expect(getDataBetweenDates(2050, 2068, [data])).toEqual([
      {
        countryName: "Aruba",
        countryCode: "ABW",
        indicatorName: "Urban population (% of total)",
  ...
  test("removeCountriesWithMissingData - test 1", () => {
    expect(removeCountriesWithMissingData([data, data2])).toEqual([data]);
  });
  test("removeCountriesWithMissingData - test 2", () => {
    expect(removeCountriesWithMissingData([data, data3])).toEqual([
      data,
      data3
    ]);
  });
  test("removeCountriesWithMissingData - test 3", () => {
    expect(removeCountriesWithMissingData([])).toEqual([]);
  });

  test("getAverageDataForEachCountry - test 1", () => {
    expect(getAverageDataForEachCountry([data])).toEqual([
      {
        countryName: "Aruba",
        countryCode: "ABW",
        indicatorName: "Urban population (% of total)",
  ...
  test("getHighestAverageData - test 1", () => {
    expect(
      getHighestAverageData([
        {
          countryName: "Aruba",
  ...
  test("getHighestAverageData - test 2", () => {
    expect(
      getHighestAverageData([
        {
          countryName: "Aruba",
  ...
  test("getHighestAverageData - test 3", () => {
    expect(
      getHighestAverageData([
        {
          countryName: "Aruba",
